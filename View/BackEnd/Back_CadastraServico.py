...
from PyQt5.QtWidgets import QWidget, QAbstractItemView, QHeaderView, QLineEdit, QLabel, QPlainTextEdit, QApplication
...
from View.FontEnd.FrmCadastraServico import Ui_FrmCadastraServico
...
class J_FrmCadastraServico(QWidget):
    def __init__(self):
        ...
        self.ui.btn_serv_sair.clicked.connect(self.close)
        self.ui.btn_serv_cancelar.clicked.connect(
