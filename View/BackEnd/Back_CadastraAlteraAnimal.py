...
from View.FontEnd.FrmCadastraAlteraAnimal import Ui_FrmCadastraAlteraAnimal
# from View.BackEnd.Back_ConsultaClienteListagem import J_FrmConsultaClienteListagem
...
class J_FrmCadastraAlteraAnimal(QMainWindow):
    def __init__(self, operacao):
        ...
        '''
        self.ui.btn_ani_cancelar.clicked.connect(lambda: (limpa_campos(self), abilita_campo(self),
                                                          reposiciona_foco(self)))
                                                          '''

        self.ui.btn_ani_cancelar.clicked.connect(
            lambda: (limpa_campos(self), abilita_campo(self), reposiciona_foco(self),
                     preencher_combobox_racas(self.ui.cad_ani_06_ob_especie.currentText()))
        )
