...
from View.FontEnd.FrmCadastraAlteraCliente import Ui_FrmCadastraAlteraCliente
...
class J_FrmCadastraAlteraCliente(QMainWindow):
    def __init__(self, operacao):
        ...
        pixmap = QPixmap('/imagens/imagem_icones/icons-câmera.png')
        self.ui.imagemcamera_frontal_label.setPixmap(pixmap)
        self.ui.imagemcamera_tras_label.setPixmap(pixmap)
    ...
    def abre_capturaimagemcliente(self, nomeImagem):
        ...
        from View.BackEnd.Back_CapturaImagem import J_FrmCapturaImagem
